...
from ultralytics.nn.modules.block import FASA,WGCA, SAKA,HRGA,HFLKA, LKA,  WCA, MDC, CoordinationAttention
    ...
    base_modules = frozenset(
        {
            ...
            C2fCIB,
            A2C2f,
            FASA,WGCA, SAKA,HRGA,HFLKA, LKA,  WCA, MDC, CoordinationAttention
        }
    )
