...
from ultralytics.nn.modules.block import FASA,WGCA, SAKA, LKA_HFGate,HRGA,HFLKA, LKA,  WCA, MDC, CoordinationAttention
...
def parse_model(d, ch, verbose=True):
    ...
    base_modules = frozenset(
        {
            ...
            C2fCIB,
            A2C2f,
            FASA,WGCA, SAKA, LKA_HFGate,HRGA,HFLKA, LKA,  WCA, MDC, CoordinationAttention
        }
    )
    ...
    for i, (f, n, m, args) in enumerate(d["backbone"] + d["head"]):  # from, number, module, args
        ...
        if m in {WGCA, SAKA, LKA_HFGate,HFLKA, LKA,  WCA, MDC}:
